...
if ENV:
    ...
    from elfina.config import Development as Config
...
client = TelegramClient("elfina", api_id, api_hash)
...
from elfina.modules.helper_funcs.handlers import CustomCommandHandler
