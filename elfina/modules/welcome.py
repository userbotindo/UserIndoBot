...
import elfina.modules.sql.welcome_sql as sql
from elfina.modules.sql.global_bans_sql import is_user_gbanned
from elfina import dispatcher, OWNER_ID, LOGGER, MESSAGE_DUMP, spamwtc
from elfina.modules.helper_funcs.chat_status import user_admin, is_user_ban_protected
from elfina.modules.helper_funcs.misc import build_keyboard, revert_buttons
from elfina.modules.helper_funcs.msg_types import get_welcome_type
from elfina.modules.helper_funcs.alternate import typing_action
from elfina.modules.helper_funcs.string_handling import (
    markdown_parser,
    escape_invalid_curly_brackets,
    markdown_to_html,
)
from elfina.modules.log_channel import loggable
        ...
        for new_mem in new_members:
            ...
            # Make bot greet admins
                ...
                update.effective_message.reply_text(
                    ...
                    " and be sure to join our channel: @elfinaupdates to know more about updates and tricks!".format(
                ...
                context.bot.send_message(
                    MESSAGE_DUMP,
                    "Elfina faranisa have been added to <pre>{}</pre> with ID: \n<pre>{}</pre>".format(
                        chat.title, chat.id
                    ),
                    parse_mode=ParseMode.HTML,
                )
